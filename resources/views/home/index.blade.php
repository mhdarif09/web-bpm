  ...
  <div class="blog-grid">
     <div class="container">
        ...
        <div class="row" style="background-color: white; padding-top: 20px; padding-bottom: 20px; border-radius: 5px;">
           ...
           <!-- Cek apakah kategori bukan "Peta Proses" -->
           <?php if($berita->nama_kategori !== 'Peta Proses') { ?>
           <!--Blog Small Post Start-->
           <div class="col-md-4 col-sm-6">
              <div class="blog-post">
                 <div class="blog-thumb"> 
                     <a href="{{ asset('berita/read/'.$berita->slug_berita) }}"><i class="fas fa-link"></i></a> 
                     <img src="{{ asset('assets/upload/image/thumbs/'.$berita->gambar) }}" alt="<?php echo $berita->judul_berita ?>"> 
                 </div>
                 <div class="post-txt">
